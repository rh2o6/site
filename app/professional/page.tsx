export default function Professional() {
  const experiences = [
    ...
    { id: 2, role: "Service Desk & Infra Analyst Intern", company: "Give & Go Prepared Foods", date: "Mar. 2025 - Aug. 2025", desc: "Provided technical hardware and software support for a multi-location workforce, using PowerShell and Batch scripting to automate repetitive tasks. I managed user accounts and device compliance through Active Directory and Microsoft Intune, and developed technical SOPs." },
